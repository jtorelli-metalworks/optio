...
describe("resolveImage", () => {
  ...
  it("uses OPTIO_AGENT_IMAGE_PREFIX for all presets", () => {
    ...
    expect(resolveImage({ preset: "ruby" })).toBe(
      "ghcr.io/jtorelli-metalworks/optio-agent-ruby:latest",
    );
    expect(resolveImage({ preset: "dart" })).toBe(
      "ghcr.io/jtorelli-metalworks/optio-agent-dart:latest",
    );
