...
- Cursor Composer agent support for headless repo tasks, including agent option
  metadata, a Cursor SDK runner, container image dependencies, and a deployment
  guide at [docs/guides/cursor-agent.md](docs/guides/cursor-agent.md).

### Changed

- Default public repository, docs, Helm image references, and GHCR image owner
  now point at the `jtorelli-metalworks/optio` fork for this release line.
